...
# Author: SNIPA VN
# Email: nguyentanloiloi528@gmail.com
# Github: https://github.com/Snhvn/ServerMinecraftAction
# Web: https://dsc.gg/servertipacvn
...
if [ $SOK_OS == "ubuntu2404" ]; then
    ...
    if [ -f /usr/bin/firewall-cmd ]; then
        firewall-cmd --zone=public --permanent --add-port=25565/tcp > /dev/null 2>&1
